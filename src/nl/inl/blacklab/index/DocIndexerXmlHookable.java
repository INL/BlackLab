...
public abstract class DocIndexerXmlHookable extends DocIndexerAbstract {
	class SaxParseHandler extends DefaultHandler {
		...
		public void characters(char[] buffer, int start, int length) throws SAXException {
			...
			DocIndexerXmlHookable.this.characters(buffer, start, length);
		}

		@Override
		public void endElement(String uri, String localName, String qName) throws SAXException {
			super.endElement(uri, localName, qName);
			DocIndexerXmlHookable.this.endElement(uri, localName, qName);
		}
		...
		public void startElement(String uri, String localName, String qName, Attributes attributes)
			...
			DocIndexerXmlHookable.this.startElement(uri, localName, qName, attributes);
		}

		@Override
		public void processingInstruction(String target, String data) throws SAXException {
			super.processingInstruction(target, data);
			DocIndexerXmlHookable.this.processingInstruction(target, data);
		}

		@Override
		public void startPrefixMapping(String prefix, String uri) throws SAXException {
			super.startPrefixMapping(prefix, uri);
			DocIndexerXmlHookable.this.startPrefixMapping(prefix, uri);
		}

		@Override
		public void endPrefixMapping(String prefix) throws SAXException {
			super.endPrefixMapping(prefix);
			DocIndexerXmlHookable.this.endPrefixMapping(prefix);
		}
	...
	public DocIndexerXmlHookable(Indexer indexer, String fileName, Reader reader) {
