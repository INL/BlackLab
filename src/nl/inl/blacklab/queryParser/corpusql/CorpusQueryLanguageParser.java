...
public class CorpusQueryLanguageParser implements CorpusQueryLanguageParserConstants {
    ...
    private String chopEnds(String regex) throws ParseException
    {
        if (regex.length() >= 2)
                return regex.substring(1, regex.length() - 1);
        throw new ParseException("Cannot chop slashes");
    }
 ...
 */
  final public TextPattern tag() throws ParseException {
    ...
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case 13:
      endTagSlash = jj_consume_token(13);
      break;
    default:
      jj_la1[2] = jj_gen;
      ;
    ...
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case 13:
      selfCloseSlash = jj_consume_token(13);
      break;
    default:
      jj_la1[4] = jj_gen;
      ;
  ...
  final public void attributes(Map<String, String> attr) throws ParseException {
    ...
    value = jj_consume_token(QUOTED_STRING);
        attr.put(name.toString(), chopEnds(value.toString()));
  }
...
/* value: a quoted string, a value expression between parens, or a negated value */
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x180,0x180,0x2000,0x200,0x2000,0xa011800,0x400,0xe0000,0x100000,0x1810000,0xa001800,0x22000a00,0x8000800,0x1810000,0x22000000,0x2000a00,0x2000800,0x2000800,};
   }
