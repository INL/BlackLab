    ...
    if (jj_2_3(6)) {
      ...
      ;
            ...
            if (m instanceof TextPatternAnyToken)
            {
                ...
                if (captureName != null) {
                    m = new TextPatternCaptureGroup(m, captureName.toString());
                }
                {if (true) return m;}
    throw new Error("Missing return statement in function");
  }
...
/* value: a quoted string, a value expression between parens, or a negated value */
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x180,0x180,0x2000,0x8000,0x200,0x8000,0x1800,0x400,0x1c0000,0x200000,0x3002000,0x200,0x28005800,0x88001a00,0x20001800,0x3002000,0x88000000,0x8001a00,0x8001800,0x8001800,};
   }
