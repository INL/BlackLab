...
if (op == null)
            {if ("" != null) return a;}
        {if ("" != null) return ContextQlParseUtils.combineClauses(a, op, b);}
    throw new Error("Missing return statement in function");
  }
...
{if ("" != null) return tp;}
    ...
    case STRING:{
      ...
      t = searchTerm();
{if ("" != null) return ContextQlParseUtils.clause(searcher, i, r, t, defaultProperty);}
      break;
      }
    default:
      jj_la1[4] = jj_gen;
...
{if ("" != null) return chopEnds(a.toString());}
      break;
      }
    default:
      jj_la1[12] = jj_gen;
