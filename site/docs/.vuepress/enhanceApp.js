export default ({ router }) => {
  router.addRoutes([
    ...
    { path: '/blacklab-server-overview.html', redirect: '/blacklab-server/' },
    { path: '/configuration-files.html', redirect: '/blacklab-server/configuration.html' },
    { path: '/blacklab-server-different-languages.html', redirect: '/blacklab-server/from-different-languages.html' },
    ...
    { path: '/improve-search-speed.html', redirect: '/blacklab-server/vmtouch.html' },
