...
This is generally the most-used endpoint for BlackLab Server, and includes the most features.
For a more gentle introduction, see the [overview](/server/overview.md).
...
| <code>capture:_groupname_:_annot_:_c_</code> | (PLANNED FEATURE) Group by a named capture group mentioned in your text pattern.                                                                                                                                                                                                                                        |
