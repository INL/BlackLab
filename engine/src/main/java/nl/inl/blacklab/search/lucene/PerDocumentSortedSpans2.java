 ...
 */
final class PerDocumentSortedSpans2 extends BLSpans {

    public static PerDocumentSortedSpans2 startPointEliminateDuplicates(BLSpans src) {
        return new PerDocumentSortedSpans2(src, true, true);
    }

    public static PerDocumentSortedSpans2 startPoint(BLSpans src) {
        return new PerDocumentSortedSpans2(src, true, false);
    }

    public static PerDocumentSortedSpans2 startPoint(BLSpans src, boolean removeDuplicates) {
        return new PerDocumentSortedSpans2(src, true, removeDuplicates);
    }

    public static PerDocumentSortedSpans2 endPoint(BLSpans src) {
        return new PerDocumentSortedSpans2(src, false, false);
    }

    public static PerDocumentSortedSpans2 get(BLSpans src, boolean sortByStartPoint, boolean removeDuplicates) {
        return new PerDocumentSortedSpans2(src, sortByStartPoint, removeDuplicates);
    }
    ...
    private PerDocumentSortedSpans2(BLSpans src, boolean sortByStartPoint, boolean eliminateDuplicates) {
