 ...
 *
 * This version takes into account that clauses may have duplicate spans (i.e.
 * same start/end but different match info). If you know this not to be the case,
 * use SpansAnd instead, as it's more efficient.
 */
class SpansAndDuplicates extends BLSpans {
     ...
     */
    public SpansAndDuplicates(BLSpans first, BLSpans second) {
