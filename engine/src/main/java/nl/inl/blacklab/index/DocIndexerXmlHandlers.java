...
public abstract class DocIndexerXmlHandlers extends DocIndexerLegacy {
    ...
    public DocIndexerXmlHandlers(DocWriter docWriter, String fileName, Reader reader) {
        ...
        boolean needsPrimaryTokenPayloads = docWriter.indexWriter().needsPrimaryTokenPayloads();
        contentsField = new AnnotatedFieldWriter(Indexer.DEFAULT_CONTENTS_FIELD_NAME, mainPropName,
                AnnotationSensitivities.defaultForAnnotation(mainPropName), false, needsPrimaryTokenPayloads);
