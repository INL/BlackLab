 ...
 *
 * The thread must cooperate by calling behave() regularly. We don't use Java's
...
public class ThreadPriority implements Prioritizable {
     ...
     *
     * That means: if it's taking long, it should sleep from time to time; if it's
     * taking too long, it should be interrupted.
     *
