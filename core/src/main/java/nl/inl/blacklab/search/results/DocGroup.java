...
public class DocGroup extends Group<DocResult> {
    ...
    public static DocGroup fromList(QueryInfo queryInfo, PropertyValue groupIdentity, List<DocResult> storedResults, int totalDocuments, int totalTokens) {
    ...
    protected DocGroup(QueryInfo queryInfo, PropertyValue groupIdentity, List<DocResult> storedResults, int totalDocuments, int totalTokens) {
