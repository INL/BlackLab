...
public class ContentStoreMemory extends ContentStore {
     ...
     *
     * @param id id of the string to get substrings from
     * @param start the starting points of the substrings (in characters)
     * @param end the end points of the substrings (in characters)
     */
    @Override
