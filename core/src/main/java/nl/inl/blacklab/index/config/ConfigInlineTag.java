...
public class ConfigInlineTag {
    ...
    /** (optional) How to display this inline tag when viewing document in the frontend
     *  (used as CSS class for this inline tag in generated XSLT; there are several
     *   predefined classes such as sentence, paragraph, line-beginning, page-beginning) */
