...
/* Generated by: ParserGeneratorCC: Do not edit this line. GeneratedContextualQueryLanguageParser.java */
...
{if ("" != null) return wrapper.chopEnds(a.toString());}
  ...
  private boolean jj_3R_3()
 {
   ...
   */
  public GeneratedContextualQueryLanguageParser(final java.io.InputStream stream) {
	  this(stream, null);
  }
   ...
   */
  public GeneratedContextualQueryLanguageParser(final java.io.InputStream stream, final String encoding) {
   try {
   ...
   */
  public GeneratedContextualQueryLanguageParser(final java.io.Reader stream) {
 ...
 token_source = new GeneratedContextualQueryLanguageParserTokenManager(jj_input_stream);
   ...
   */
  public GeneratedContextualQueryLanguageParser(final GeneratedContextualQueryLanguageParserTokenManager tm) {
	 token_source = tm;
	 token = new Token();
	 jj_ntk = -1;
	 jj_gen = 0;
   ...
   * @param tm Token manager to use
   */
  public void ReInit(final GeneratedContextualQueryLanguageParserTokenManager tm) {
	 token_source = tm;
	 token = new Token();
	 jj_ntk = -1;
	 jj_gen = 0;
