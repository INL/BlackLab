...
public class CorpusQueryLanguageParser implements CorpusQueryLanguageParserConstants {
    ...
    public void setDefaultProperty(IndexMetadata structure, String fieldName) {
...
// --- Grammar rules start here --- 
    ...
    final public TextPattern constrainedQuery() throws ParseException {
        TextPattern a = null;
        MatchFilter b = null;
        a = complexQuery();
    ...
    final public MatchFilter constraint() throws ParseException {
    ...
    final public MatchFilter simpleConstraint() throws ParseException {
    ...
    final public Token equalityOperator() throws ParseException {
        Token t = null;
        switch ((jj_ntk == -1) ? jj_ntk_f() : jj_ntk) {
        case 15: {
    ...
    final public MatchFilter constraintValue() throws ParseException {
        MatchFilter v = null;
        String q = null;
        Token s = null;
        String l = null;
        ...
        case SINGLE_QUOTED_STRING: {
            ...
            {
                if ("" != null)
                    return new MatchFilterString(q);
            }
            break;
        }
        case 17: {
        ...
        if (b.toString().equals("->")) {
            if (true)
                throw new UnsupportedOperationException(
                        "Implication operator only supported within global constraints");
        }
        if (b.toString().equals("&")) {
            if ("" != null)
    ...
    final public TextPattern tag() throws ParseException {
        ...
        if (endTagSlash != null) {
            ...
            {
                if ("" != null)
                    return new TextPatternEdge(tags, true);
            } // right edge
        }
        {
            if ("" != null)
                return new TextPatternEdge(tags, false);
        } // left edge
    ...
    final public String captureLabel() throws ParseException {
        Token l = null;
        switch ((jj_ntk == -1) ? jj_ntk_f() : jj_ntk) {
        case NAME: {
    ...
    final public String flags() throws ParseException {
        Token f;
    ...
    final public TextPattern attValuePair() throws ParseException {
        ...
        if (jj_2_5(2)) {
            ...
            case NAME: {
                ...
                {
                    if ("" != null)
                        return new TextPatternNot(propertyClause(prop, v));
                }
                break;
            }
            case QUOTED_STRING:
    ...
    final public String propName() throws ParseException {
    ...
    private static void jj_la1_init_0() {
        jj_la1_0 = new int[] { 0x4000, 0xc0000000, 0x18000, 0x18000, 0x100000, 0xa3a00, 0x180, 0x180, 0xc0000000,
                0x400000, 0x200, 0x400000, 0x3000, 0x800, 0x7000000, 0x8000000, 0xc0000000, 0xa00, 0x223000, 0xa00,
                0x400, 0xa3200, 0x3000, 0xc0000000, 0xa0000, 0x400, 0x400, 0x400, 0x23200, 0x400000, 0x23000,
                0x23000, };
    }

    private static void jj_la1_init_1() {
        jj_la1_1 = new int[] { 0x0, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x0,
                0x4, 0x0, 0x0, 0x0, 0x4, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, };
    }
