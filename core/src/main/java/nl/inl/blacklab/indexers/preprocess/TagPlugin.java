...
public interface TagPlugin extends Plugin {
	 ...
	 * see {@link ConvertPlugin#getOutputFormat()}.
	 *
	 ...
	 * This should match a {@link nl.inl.blacklab.index.DocIndexerFactory.Format} so that the tagged data can then be indexed by a {@link DocIndexer}
	 *
