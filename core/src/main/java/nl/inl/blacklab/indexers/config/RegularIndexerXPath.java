...
public class RegularIndexerXPath extends DocIndexerConfig {
    ...
    public void index() throws MalformedInputFile, PluginException, IOException {
        ...
        if (inputDocument.length > 0) { // VTD doesn't like empty documents
            try {
                ...
                NodeList docs = (NodeList) documents.evaluate(new InputSource(new ByteArrayInputStream(inputDocument)), XPathConstants.NODESET);
     ...
     *
     */
    protected void indexDocument(Node doc) {
