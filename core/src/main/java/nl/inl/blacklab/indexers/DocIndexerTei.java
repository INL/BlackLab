...
public class DocIndexerTei extends DocIndexerTeiBase {
    ...
    public static String getDisplayName() { return "TEI-DocIndexer (alternate TEI indexer)"; }
    public static String getDescription() { return
            "Main contents should be in body element, should be tokenized and PoS tags should be in the type attribute."; }
