...
public class TestHitProperties {
    ...
    public void testHitPropHitText() {
        ...
        HitGroup group = g.getGroup(new PropertyValueContextWords(index, wordAnnotation, MatchSensitivity.SENSITIVE, new int[] { term("the") }));
        Assert.assertEquals(3, group.size());
        group = g.getGroup(new PropertyValueContextWords(index, wordAnnotation, MatchSensitivity.SENSITIVE, new int[] { term("The") }));
    ...
    public void testHitPropContextWords() {
        ...
        Assert.assertEquals(1, group.size());
        group = g.getGroup(
                new PropertyValueContextWords(index, wordAnnotation, MatchSensitivity.SENSITIVE, new int[] { term("over"), term("the"), NO_TERM }));
        Assert.assertEquals(1, group.size());
        group = g.getGroup(
                new PropertyValueContextWords(index, wordAnnotation, MatchSensitivity.SENSITIVE, new int[] { term("May"), term("the"), NO_TERM }));
        Assert.assertEquals(1, group.size());
        group = g.getGroup(
                new PropertyValueContextWords(index, wordAnnotation, MatchSensitivity.SENSITIVE, new int[] { term("is"), term("the"), NO_TERM }));
        Assert.assertEquals(1, group.size());
    }
    ...
    public void testHitPropContextWordsReverse() {
        ...
        HitGroup group;
        group = g.getGroup(new PropertyValueContextWords(index, wordAnnotation,
