...
public class FileUploadHandler {
	...
	private static final long MAX_UPLOAD_SIZE = FileUtils.ONE_MB * 25;
	 ...
	 * @param request
	 * @return the file
	 * @throws BlsException on invalid upload parameter/missing file/too large file/general IO errors
	 */
