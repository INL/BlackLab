...
public class RequestHandlerBlsHelp extends RequestHandler {
	...
	public int handle(DataStream ds) {
		...
		ds.startMap()
			...
			.entry("searchHits", urlIndexPrefix + "hits?patt=%22dog%22&filter=author:barker&number=50&wordsaroundhit=8")
			...
			.entry("documentSnippetAroundHit", urlIndexPrefix + "docs/MYDOCPID00001/snippet?hitstart=47&hitend=48&wordsaroundhit=8")
		.endMap();
		return HTTP_OK;
	}
