...
public class GapFiller {
	 ...
	 */
	private static Iterable<CSVRecord> parseTsv(BufferedReader in, char separator, String lineSeparator) throws IOException {
	 ...
	 * @param valueSeparator separator to use when filling in multiple values into a gap
	 * @return the filled-in template
	 * @throws ParseException if the resulting CQL contains an error
	 */
	private static TextPattern parseGapQuery(String template, String gapRegex, Iterable<CSVRecord> values, String valueSeparator) throws ParseException {
